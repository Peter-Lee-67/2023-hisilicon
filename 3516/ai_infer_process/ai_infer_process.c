 ...
 */
// 2023_05_09 NmsThresh: 0.3 -> 0.6 && ConfThresh: 0.25 -> 0.5
    ...
    SAMPLE_SVP_NNIE_PARAM_S *pstNnieParam, SAMPLE_SVP_NNIE_YOLOV2_SOFTWARE_PARAM_S* pstSoftWareParam)
{
    ...
    /*
    pstSoftWareParam->u32ClassNum = 1; // 1: class number
    */
    pstSoftWareParam->u32ClassNum = 4; // 4: class number
    /*
    pstSoftWareParam->u32GridNumHeight = 12; // 12: GridNumHeight
    pstSoftWareParam->u32GridNumWidth = 20; // 20: GridNumWidth
    */
    pstSoftWareParam->u32GridNumHeight = 16; // 16: GridNumHeight
    pstSoftWareParam->u32GridNumWidth = 16; // 16: GridNumWidth
