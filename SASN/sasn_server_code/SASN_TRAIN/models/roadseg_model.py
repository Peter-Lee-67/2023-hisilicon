...
class RoadSegModel(BaseModel):
    ...
    def initialize(self, opt, dataset):
        ...
        self.netRoadSeg = networks.define_RoadSeg(dataset.num_labels, init_type=opt.init_type, init_gain= opt.init_gain, gpu_ids= self.gpu_ids, net_type=opt.model_type)
    ...
    def forward(self):
        self.output = self.netRoadSeg(self.rgb_image)
