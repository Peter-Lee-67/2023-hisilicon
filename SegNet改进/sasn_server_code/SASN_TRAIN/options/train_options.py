...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        # parser.add_argument('--csv_name', required=True, help='path to training, validation')
        parser.add_argument('--continue_train', action='store_true', help='continue training: load the latest model')
        # parser.add_argument('--visual', action='store_true', help='check whereis wrong')
        parser.add_argument('--early_stop', type=int, default=1000, help='check whereis wrong')
        parser.add_argument('--save_begin', type=int, default=0, help='check whereis wrong')
        ...
        parser.add_argument('--lr_decay_epochs', type=int, default=20, help='multiply by a gamma every lr_decay_epoch epochs')
